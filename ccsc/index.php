      ...
      <aside class="col-span-12 md:col-span-3">
        <nav class="rounded-lg border bg-white shadow-sm">
          ...
          <ul class="p-2 space-y-1 text-sm">
            <li>
              <a id="nav-dash" href="<?= htmlspecialchars(url_for('/ccsc/')) ?>" class="flex items-center justify-between rounded px-3 py-2 bg-blue-50 text-blue-700 font-medium">
            ...
            <li>
              <a id="nav-trans" href="<?= htmlspecialchars(url_for('/ccsc/transactions.php')) ?>" class="block rounded px-3 py-2 hover:bg-blue-50">Transactions</a>
            </li>
